...
public class Comidas extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    private Spinner opciones ;
    private ImageView fotoperfil;
    private String productoC,descripC,PrecioC;
    ...
    public void consultarbdcomida(View view)
    {
       SqlLiteBase objetoBD = new SqlLiteBase(this,"TacosLocos",null,1);
        ...
        productoC   = fila2.getString(1).toString();
        descripC    = fila2.getString(2).toString();
        PrecioC     = fila2.getString(3).toString();
    ...
    public void RegistrarComidas(View view)
    {
        SqlLiteBase objetoBD = new SqlLiteBase(this,"TacosLocos",null,1);
        SQLiteDatabase basededatos = objetoBD.getWritableDatabase();//abro la BD para escritura y lectura
        String cantidad             =   (cantidadEdit.getText().toString());
        String codigocliente        =   idGoogle.getText().toString();
        String Nombre               =   productoC.toString();
        String Descripcion          =   descripC.toString();
        String Precio               =   PrecioC.toString();
